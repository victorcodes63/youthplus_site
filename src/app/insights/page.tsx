...
export default function InsightsPage() {
  return (
    <main className="bg-white text-[#0A0A0A]">
      <section className="relative border-b border-borderLight/80 bg-[linear-gradient(180deg,#fafafa_0%,#ffffff_100%)] pb-12 md:pb-16">
        <SectionDivider contentWidth className="absolute top-0 opacity-80" />
        <div className="page mx-auto max-w-[1440px] pt-[calc(var(--site-header-height)+2.5rem)] md:pt-[calc(var(--site-header-height)+3rem)]">
